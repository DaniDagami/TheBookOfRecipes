...
('Shrimp Scampi', 'A flavorful seafood pasta dish with shrimp, garlic, lemon, and butter.', '1. Cook pasta according to package instructions, then drain and set aside. 2. In a large skillet, melt butter over medium heat. 3. Add minced garlic and sauté for about 1 minute until fragrant. 4. Add shrimp to the skillet, season with salt and pepper, and cook until pink (about 3-4 minutes). 5. Add white wine (or chicken broth) and lemon juice, and simmer for 2-3 minutes. 6. Toss the cooked pasta into the skillet, mixing well to coat in the sauce. 7. Garnish with fresh parsley and grated Parmesan cheese, then serve.', 10, 'Images/shrimp_scampi.png'),
